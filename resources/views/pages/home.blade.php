...
<div id="page" class="page_wapper hfeed site">
    ...
    <div id="wrapper_full" class="content_all_warpper">
                        ...
                        <div class="header_top_inner">
                            ...
                            <div class="top_right text-right">
                                <ul class="contact_info_two">
                                    <li class="single">
                                        <p> <span class="icon-telephone"></span> <a href="tel:+91 887 760 1210">+91 887 760 1210</a>
                                        </p>
                                    </li>
                                    <li class="single">
                                        <p><span class="icon-mail"></span><a href="mailto:sendmail@creote.com">Contact@softwareride.com</a>
                                        </p>
                                    </li>
                                    <li class="single">
                                        <p> <span class="icon-location2"></span>
                                            Kailash nagar, diliya, sasaram </p>
                                    </li>
                                </ul>
                            </div>
                        </div>
                                ...
                                <div class="header_menu_box">
                                    <div class="navigation_menu">
                                        <ul id="myNavbar" class="navbar_nav">
                                            ...
                                            <li class="menu-item menu-item-has-children dropdown nav-item">
                                                <a href="#projects" class="dropdown-toggle nav-link">
                                                    <span>Projects</span>
                                                </a>
                                            </li>
                                            <li class="menu-item  menu-item-has-children dropdown nav-item">
                                                <a href="#plan" class="dropdown-toggle nav-link">
                                                    <span>Plans</span>
                                                </a>
                                            </li>
                                        </ul>
        ...
        <div id="content" class="site-content ">
            ...
            <!---sliders-->
            <div id="home" class="banner_section_hm_16 pd_left_100 pd_right_100 md_pd_left_15 md_pd_right_15">
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="left_content">
                                                        ...
                                                        <div class="quotes">
                                                            ...
                                                            <h5>Teamwork fuels software solutions, <br>turning ordinary into extraordinary.</h5>
                                                        </div>
                                                        <div class="authour_dtls">

                                                            <!-- <img src="assets/images/sign-d.png" class="sign" alt="image"> -->
                                                            <!-- <h4>
            ...
            <!---sliders-->
            <!--feature-->
            <section id="about" class="service-section-one">
                <!--===============spacing==============-->
                        ...
                        <div class="col-lg-7">
                            <div class="title_all_box style_one  dark_color">
                                <div class="title_sections left">
                                    <div class="title"> Experiences for Employees</div>
                                    <p> "Empower your workforce by empathizing with their emotions and viewpoints at every interaction, enabling you to take meaningful action and shape experiences around what truly matters to your people.</p>
                                </div>
                            ...
                            <div class="icon_box_all  style_eight">
                                <div class="icon_content">
                                    ...
                                    <div class="text_box">
                                        ...
                                        <p>
                                        We are available round-the-clock to provide you with timely assistance and support whenever you need it.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="icon_box_all  style_eight">
                                <div class="icon_content">
                                    ...
                                    <div class="text_box">
                                        ...
                                        <p>
                                        Our skilled team is passionate about creating captivating user experiences that drive engagement and satisfaction.
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="icon_box_all  style_eight">
                                <div class="icon_content">
                                    ...
                                    <div class="text_box">
                                        ...
                                        <p> Our innovative and data-driven solutions are designed to solve complex problems and help your business thrive.
                                        </p>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="title_all_box style_one  dark_color">
                                <div class="title_sections left">
                                    ...
                                    <div class="title" style="font-size: 30px"> Software solutions are revolutionizing businesses with transformative efficiency</div>
                                    <p>Software solutions revolutionize businesses, driving transformative efficiency by streamlining processes and unleashing growth potential in the digital age.</p>
                                </div>
                            </div>
                            <!--===============spacing==============-->
                            <div class="pd_bottom_20"></div>
                            ...
                            <div class="progress_bar style_two">
                                <div class="progress_new">
                                    <div class="ProgressBar ProgressBar--animateText" data-progress="70">
                                        <svg class="ProgressBar-contentCircle" height="170" width="170">
                                            ...
                                            <circle transform="rotate(-90, 85, 85)" class="ProgressBar-circle" cx="85" cy="85" r="75" style="stroke-dasharray: 471px; stroke-dashoffset: 141.3px;">
                                            </circle>
                                        </svg>
                                    </div>
                                ...
                                <div class="content_box">
                                    <h2>15+</h2>
                                    <h3>Projects </h3>
                                    <p>We've tackled challenging projects for countless clients, showcasing our expertise and commitment to delivering exceptional results. </p>
                                </div>
                            </div>
                            <!--===============spacing==============-->
                            <div class="pd_bottom_20"></div>
                                            ...
                                            <div class="s_tab fade active-tab show" id="tabtabone">
                                                <div class="tab_content one">
                                                    <div class="content_bx">
                                                        ...
                                                        <p>Empowering businesses through innovative software solutions, Softwaerride.com aims to revolutionize the industry and drive growth worldwide. Guided by our values of innovation, excellence, collaboration, integrity, and continuous learning, we deliver exceptional results and forge lasting client partnerships.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="s_tab fade " id="tabtabtwo">
                                                <div class="tab_content one">
                                                    <div class="content_bx">
                                                        ...
                                                        <p>Revolutionizing the software industry with innovative solutions. Driving business success through cutting-edge software products and services. Empowering organizations to thrive in a digital world.</p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="s_tab fade " id="tabtabthree">
                                                <div class="tab_content one">
                                                    <div class="content_bx">
                                                        ...
                                                        <p>Excellence in delivering exceptional software solutions, fostering collaboration through teamwork and open communication, and driving innovation by embracing creativity and staying ahead of technological advancements.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <!---about end-->
            <!--service post-->
            <section id="expertise" class="service-section-two pd_left_100 pd_right_100 md_pd_left_15 md_pd_right_15">
                            ...
                            <div class="col-lg-6 m-auto">
                                <div class="title_all_box style_one text-center">
                                    <div class="title_sections">
                                        ...
                                        <div class="title">Key Areas of Expertise</div>
                                        <p>
                                        Softwareride.com specializes in providing expertise across key areas, including ecommerce, blogs, SaaS products, and more. With a deep understanding of these domains, we deliver tailored solutions that drive online businesses, empower content creation, and enhance the efficiency and effectiveness of SaaS products.
                                        </p>
                                    </div>
                                    <!--===============spacing==============-->
                                    <div class="pd_bottom_20"></div>
                                ...
                                <div class="service_all_styles carousel owl_new_one">
                                    <div class="owl_nav_none owl_dots_none owl_type_two theme_carousel owl-theme owl-carousel" data-options='{"loop": true, "margin": 30, "autoheight":true, "lazyload":true, "nav": true, "dots": true, "autoplay": true, "autoplayTimeout": 7000, "smartSpeed": 1800, "responsive":{ "0" :{ "items": "1" }, "768" :{ "items" : "3" } , "1000":{ "items" : "3" }}}'>
                                        ...
                                        <div class="service_box  type_one clearfix">
                                            <div class="image_box">
                                                <img src="assets/images/service/service-image-6.jpg" class="img-fluid" alt="img" />
                                        ...
                                        <div class="service_box  type_one clearfix">
                                            <div class="image_box">
                                                <img src="assets/images/service/service-image-5.jpg" class="img-fluid" alt="img" />
                                                <div class="overlay"></div>
                                            </div>
                                            <div class="content_box">
                                                <div class="icon_box clearfix">
                                        ...
                                        <div class="service_box  type_one clearfix">
                                            <div class="image_box">
                                                <img src="assets/images/service/service-image-4.jpg" class="img-fluid" alt="img" />
                                                <div class="overlay"></div>
                                            </div>
                                            <div class="content_box">
                                                <div class="icon_box clearfix">
                        ...
                        <div class="col-lg-12">
                            <div class="title_all_box style_one text-center dark_color">
                                <div class="title_sections">
                                    ...
                                    <h2>Product Delivery Process</h2>
                                </div>
                                <!--===============spacing==============-->
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <div class="process_box style_four dark_color">
                                <div class="process_box_outer_four ">
                                    ...
                                    <div class="content_box">
                                        <h2><a href="#" target="_blank" rel="nofollow">Preparing Work Flow</a></h2>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                            <div class="process_box style_four dark_color">
                                <div class="process_box_outer_four ">
                                    ...
                                    <div class="content_box">
                                        <h2><a href="#" target="_blank" rel="nofollow">Work with preplanned milestones</a>
                                        </h2>
                        ...
                        <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12">
                            ...
                            <div class="process_box style_four dark_color">
                                <div class="process_box_outer_four ">
                                    ...
                                    <div class="content_box">
                                        <h2><a href="#" target="_blank" rel="nofollow">Testing &amp;
                                                Delivery</a></h2>
            ...
            <!----process end---->
            <!----contact---->
            <section id="reach-us" class="contact-section bg_light_1 pd_left_100 pd_right_100 md_pd_left_15 md_pd_right_15">
                <div class="inner_section rounded_radius bg_op_1" style="background: url(assets/images/home-16-contact-bg.jpg);">
                    <!--===============spacing==============-->
                    <div class="pd_top_80"></div>
                    <!--===============spacing==============-->
                    <div class="container">
                            ...
                            <div class="contact_form_box_all type_four mr_top_minus_320 mr_md_top_zero">
                                ...
                                <div class="contact_form_box_inner simple_form">
                                    <div class="contact_form_shortcode">
                                        <form action="{{ url('/contact') }}" method="post" class="wpcf7-form init" novalidate="novalidate" data-status="init">
                                        @csrf
                                            <div class="row gutter_15px">
                                                <div class="col-lg-6">
                                                    <label> Your name<br>
                                                        <span class="wpcf7-form-control-wrap" data-name="name"><input type="text" name="name" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Enter Your Name"></span><br>
                                                ...
                                                <div class="col-lg-6">
                                                    <label> Phone Number<br>
                                                        <span class="wpcf7-form-control-wrap" data-name="phone"><input type="tel" name="phone" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-tel wpcf7-validates-as-tel" aria-invalid="false" placeholder="Enter Your Number"></span><br>
                                                        <i class="fa fa-phone"></i><br>
                                                    </label>
                                                </div>
                                                <div class="col-lg-6">
                                                    <label> Subject<br>
                                                        <span class="wpcf7-form-control-wrap" data-name="subject"><input type="text" name="subject" value="" size="40" class="wpcf7-form-control wpcf7-text wpcf7-validates-as-required" aria-required="true" aria-invalid="false" placeholder="Enter Your Subject"></span><br>
                                                        <i class="fa fa-folder"></i><br>
                                                    </label>
                                                </div>
                                                <div class="col-lg-12 text_area">
                                                    <label> Your message (optional)<br>
                                                        <span class="wpcf7-form-control-wrap" data-name="message"><textarea name="message" cols="40" rows="10" class="wpcf7-form-control wpcf7-textarea" aria-invalid="false" placeholder="Enter Your Message"></textarea></span><br>
                                ...
                                <div class="contact_box_content style_two">
                                    <div class="contact_box_inner color_one">
                                        ...
                                        <div class="text ">
                                            ...
                                            <p>
                                                Phone: +91 887 760 1210 &amp; Email: sendmail@qetus.com
                                            </p>
                                        </div>
                                    </div>
                                </div>
            ...
            <!--project-->
            <section id="projects" class="project-section pd_left_100 pd_right_100 md_pd_left_15 md_pd_right_15 mr_bottom_minus_90 z_99 position-relative">
                            ...
                            <div class="col-md-12">
                                <div class="title_all_box style_one text-center">
                                    <div class="title_sections">
                                        ...
                                        <div class="title">Finished Projecs</div>
                                    </div>
                                </div>
                            </div>
                            <!--===============spacing==============-->
                            ...
                            <div class="row">
                                <div class="col-xl-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="project_post style_eight">
                                        <div class="image_box ">
                                            <img src="assets/images/projects/project-1.png" class="img-fluid height_350px" alt="img" />
                                            <a data-fancybox="gallery" href="assets/images/projects/project-1.png">
                                        ...
                                        <div class="content_box ">
                                            <h2 class="entry-title">
                                                <a href="https://www.acting-international.com/">Acting International</a>
                                            </h2>
                                            <p> <a href="https://www.acting-international.com/" class="cat">PHP project</a> </p>
                                            <a href="https://www.acting-international.com/" class="arrow_btn ">
                                ...
                                <div class="col-xl-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="project_post style_eight">
                                        <div class="image_box ">
                                            <img src="assets/images/projects/project-2.png" class="img-fluid height_350px" alt="img" />
                                            <a data-fancybox="gallery" href="assets/images/projects/project-2.png">
                                                <span class="icon-plus zoom_icon"></span>
                                            </a>
                                            <div class="gradient"></div>
                                        </div>
                                        <div class="content_box ">
                                            <h2 class="entry-title"><a href="https://mailbx.app/">MailBx</a>
                                            </h2>
                                            <p> <a href="https://mailbx.app/" class="cat">Flutter and Laravel</a></p>
                                            <a href="https://mailbx.app/" class="arrow_btn ">
                                                <span class="icon-right-arrow-long"></span>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="project_post style_eight">
                                        <div class="image_box ">
                                            <img src="assets/images/projects/project-3.png" class="img-fluid height_350px" alt="img" />
                                            <a data-fancybox="gallery" href="assets/images/projects/project-3.png">
                                                <span class="icon-plus zoom_icon"></span>
                                            </a>
                                            <div class="gradient"></div>
                                        </div>
                                        <div class="content_box ">
                                            <h2 class="entry-title"><a href="https://samasthguru.com/">SamasthGuru</a></h2>
                                            <p>
                                                <a href="https://samasthguru.com/" class="cat">Laravel</a>
                                            </p>
                                            <a href="https://samasthguru.com/" class="arrow_btn">
                                                <span class="icon-right-arrow-long"></span>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="project_post style_eight">
                                        <div class="image_box ">
                                            <img src="assets/images/projects/project-4.png" class="img-fluid height_350px" alt="img" />
                                            <a data-fancybox="gallery" href="assets/images/projects/project-4.png">
                                                <span class="icon-plus zoom_icon"></span>
                                            </a>
                                            <div class="gradient"></div>
                                        </div>
                                        <div class="content_box ">
                                            <h2 class="entry-title"><a href="https://vaartaavah.com/">Vaartaavah</a>
                                            </h2>
                                            <p>
                                                <a href="https://vaartaavah.com/" class="cat">Wordpress</a>
                                            </p>
                                            <a href="https://vaartaavah.com/" class="arrow_btn ">
                                                <span class="icon-right-arrow-long"></span>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="project_post style_eight">
                                        <div class="image_box ">
                                            <img src="assets/images/projects/project-5.png" class="img-fluid height_350px" alt="img" />
                                            <a data-fancybox="gallery" href="assets/images/projects/project-5-png">
                                                <span class="icon-plus zoom_icon"></span>
                                            </a>
                                            <div class="gradient"></div>
                                        </div>
                                        <div class="content_box ">
                                            <h2 class="entry-title">
                                                <a href="https://organizein.com/">
                                                    Organizein
                                                </a>
                                            </h2>
                                            <p>
                                                <a href="https://organizein.com/" class="cat">NodeJs and PHP</a>
                                            </p>
                                            <a href="https://organizein.com/" class="arrow_btn ">
                                                <span class="icon-right-arrow-long"></span>
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-4 col-md-4 col-sm-6 col-xs-12">
                                    <div class="project_post style_eight">
                                        <div class="image_box ">
                                            <img src="assets/images/projects/project-6.png" class="img-fluid height_350px" alt="img" />
                                            <a data-fancybox="gallery" href="assets/images/projects/project-6.png">
                                                <span class="icon-plus zoom_icon"></span>
                                            </a>
                                            <div class="gradient"></div>
                                        </div>
                                        <div class="content_box ">
                                            <h2 class="entry-title">
                                                <a href="https://fametechz.com/">
                                                    FameTechz
                                                </a>
                                            </h2>
                                            <p>
                                                <a href="https://fametechz.com/" class="cat">Wordpress</a>
                                            </p>
                                            <a href="https://fametechz.com/" class="arrow_btn ">
                                                <span class="icon-right-arrow-long"></span>
                                            </a>
                                        </div>
                                    </div>
                     ...
                     <div class="col-lg-12">
                        <div class="price_plan_with_tab price_tb_style_one">
                           <div class="tab-content price_tab_content" id="myTabContent">
                              <div class="tab-pane fade active show mt-4" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                 <div class="row">
                                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                       <div class="price_plan_box style_one ">
                                        <div class="tag">Maintainance</div>
                                          <div class="inner_box">
                                             <div class="top">
                                                <h2>Software Maintainance </h2>
                                                <p>Starting Price Per Project</p>
                                             </div>
                                             <div class="mid">
                                                <h4>99<span>$</span></h4>
                                                <p>We excel in Software Maintenance for seamless functionality and optimal performance.</p>
                                             </div>
                                             <div class="bottom">
                                                <ul>
                                                   <li>
                                                   ...
                                                   <li>
                                                      <span> Scalability Enhancements</span>
                                                      <i class="fa fa-check"></i>
                                                   </li>
                                                </ul>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                       <div class="price_plan_box style_one ">
                                          ...
                                          <div class="inner_box">
                                             ...
                                             <div class="mid">
                                                <h4>149<span>$</span></h4>
                                                <p>Enabling growth and efficiency through personalized application development.
                                                </p>
                                             </div>
                                             <div class="bottom">
                                                <ul>
                                    ...
                                    <div class="col-xl-4 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                       <div class="price_plan_box style_one ">
                                          ...
                                          <div class="inner_box">
                                             ...
                                             <div class="mid">
                                                <h4>249<span>$</span></h4>
                                                <p>Innovative application development to stay ahead in today's competitive market.
                                                </p>
                                             </div>
                                             <div class="bottom">
                                                <ul>
            ...
            <!--tab section-->
            <!---call to action--->
            <section class="call-to-action mr_bottom_minus_140 position-relative z_99">
               <div class="container">
                  <div class="call_to_action style_two">
                     <div class="image">
                        <img src="assets/images/call-to-pric-bg-1.jpg" class="img-fluid" alt="image">
                     </div>
                                 ...
                                 <div class="main_content">
                                    ...
                                    <div class="bottom_content">
                                       <div class="call_content">
                                          ...
                                          <div class="content_bx">
                                             <h2>Get In Touch</h2>
                                             <p> Email: Contact@softwareride.com &amp; Phone: +91 887 760 1210 </p>
                                          </div>
                                       </div>
                                    </div>
                                 </div>
            ...
            <!---call to action--->
            {{-- <section class="service-box-section bg_light_1">
               <!--===============spacing==============-->
               ...
               <div class="container">
                  <div class="row">
                     <div class="col-lg-12">
                        <div class="title_all_box style_one text-center dark_color">
                           <div class="title_sections">
                              <div class="before_title">Check Out</div>
                     ...
                     <div class="col-lg-4">
                        <div class="service_box style_four dark_color">
                           <div class="service_content">
                              <a href="#">
                                 <div class="image_box">
                                    <img src="assets/images/projects/project-1.png" class="img-fluid" alt="Service Image">
                     ...
                     <div class="col-lg-4">
                        <div class="service_box style_four dark_color">
                           <div class="service_content">
                              <a href="#">
                                 <div class="image_box">
                                    <img src="assets/images/about/about-12.jpg" class="img-fluid" alt="Service Image">
                     ...
                     <div class="col-lg-4">
                        <div class="service_box style_four dark_color">
                           <div class="service_content">
                              <a href="#">
                                 <div class="image_box">
                                    <img src="assets/images/blog/blog-image-10.jpg" class="img-fluid" alt="Service Image">
            ...
            <!--testimonial-->
            <section class="testimonial-section border_solid_2px rounded_radius bg_op_1" style="background: url(assets/images/home-16-testi.jpg);">
                <!--===============spacing==============-->
                                    ...
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide">
                                            <div class="testimonial_box clearfix">
                                                <img src="assets/images/review-1.png" alt="image">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="testimonial_box clearfix">
                                                <img src="assets/images/review-2.png" alt="image">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="testimonial_box clearfix">
                                                <img src="assets/images/review-3.png" alt="image">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="testimonial_box clearfix">
                                                <img src="assets/images/review-4.png" alt="image">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="testimonial_box clearfix">
                                                <img src="assets/images/review-5.png" alt="image">
                                            </div>
                                        </div>
                                        <div class="swiper-slide">
                                            <div class="testimonial_box clearfix">
                                                <img src="assets/images/review-6.png" alt="image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <div class="footer_area sixteen position-relative pd_left_100 pd_right_100  md_pd_left_15 md_pd_right_15" id="footer_contents">
        ...
        <div class="inner_section">
            <div class="footer_widgets_wrap bg_op_1 rounded_radius" style="background: url(assets/images/home-16-footer-bg.jpg);">
                <!--===============spacing==============-->
                <div class="pd_top_90"></div>
                <!--===============spacing==============-->
                <div class="default-container">
                        ...
                        <div class="col-lg-3 col-md-6 col-sm-12">
                            ...
                            <div class="footer_widgets about_company light_color">
                                <div class="about_company_inner">
                                    <div class="content_box">
                                        <p class="color_white">
                                        We are a leading software startup revolutionizing industries with innovative solutions and empowering businesses to thrive in the digital era.
                                        </p>
                                        <div class="consulting">
                                            ...
                                            <div class="help_con">
                                                ...
                                                <h2>
                                                    <a href="#" class="color_white">Our Consultation </a>
                                                </h2>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="foo_cont_inner">
                                        ...
                                        <div class="bottom">
                                            ...
                                            <div class="con_content">
                                                <h5> Phone :</h5>
                                                <a href="tel:+91 887 760 1210" class="color_white"> +91 887 760 1210</a>
                                            </div>
                                            <div class="con_content">
                                                <h5> Mail Us :</h5>
                                                <a href="mailto:contact@softwareride.com" class="color_white"> Contact@softwareride.com</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="default-container">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-md-12">
                            <div>
                                © 2023 <a href="https://themeforest.net/user/steelthemes">SoftwareRide.</a> All Rights
                                Reserved.
                            </div>
                        </div>
